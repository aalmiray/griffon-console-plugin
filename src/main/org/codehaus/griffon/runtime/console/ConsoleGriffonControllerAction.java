 ...
 */
package org.codehaus.griffon.runtime.console;

import griffon.console.widgets.MutableAction;
 ...
 */
public class ConsoleGriffonControllerAction extends AbstractGriffonControllerAction {
    private final MutableAction toolkitAction;

    public ConsoleGriffonControllerAction(final GriffonControllerActionManager actionManager, final GriffonController controller, final String actionName) {
        super(actionManager, controller, actionName);
        final ConsoleGriffonControllerAction self = this;
